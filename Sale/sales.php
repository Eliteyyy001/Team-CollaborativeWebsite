...
if ($result === false) {
    // Show a simple error instead of crashing
...
<?php if (!empty($queryError)): ?>
    <p style="color:red;">Database error: <?php echo htmlspecialchars($queryError); ?></p>
<?php endif; ?>
...
<table class="cart-table">
    ...
    <tbody>
        <?php if (!empty($queryError)): ?>
            <tr>
                <td colspan="6">Could not load sales because of a database error.</td>
            </tr>
